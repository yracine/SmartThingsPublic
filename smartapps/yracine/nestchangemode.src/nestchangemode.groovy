...
definition(
	...
	author: "Yves Racine",
	description:
	"Change the Nest mode (Away, Home) manually (by pressing the app's play button) or automatically at the Nest thermostat(s) based on the hub's location mode(s)",
	category: "My Apps",
